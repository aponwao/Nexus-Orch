...
```bash
git remote add encore encore://multi-tenant-project-backend-qd22
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/multi-tenant-project-backend-qd22/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/multi-tenant-project-backend-qd22/settings/integrations/github)
